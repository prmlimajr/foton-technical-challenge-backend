    ...
    .then(function () {
      ...
      return knex('books').insert([
        ...
        },
        {
          ...
          cover:
            'https://storage.googleapis.com/du-prd/books/images/9780062876003.jpg',
        },
        {
          name: 'The Red Book',
          ...
          cover:
            'https://storage.googleapis.com/du-prd/books/images/9780316499408.jpg',
        },
        {
          name: 'Northern Spy',
          author: 'Flynn Berry',
          ...
          cover:
            'https://storage.googleapis.com/du-prd/books/images/9780735224995.jpg',
        },
        {
          ...
          cover:
            'https://storage.googleapis.com/du-prd/books/images/9780765387561.jpg',
        },
      ]);
    });
};
